            ...
            <div className="container">
              ...
              <div className="about-content">
                <p className="about-description">
                  ...
                  Engineer for 2+ years, building and shipping production
                  systems, from backend APIs and databases to modern web
                  interfaces. I have a passion for all things tech, and am
                  actively looking to learn about new technologies and
                ...
                <article className="experience-card liquid-glass featured">
                  ...
                  <ul className="experience-highlights">
                    <li>
                      ...
                      authentication system (Supabase Auth with row-level
                      security via Next.js middle-ware), enabling secure,
                      long-lived sessions and protected routes across
                      multi-tenant workspaces
                    </li>
                    <li>
                      Architected a normalized PostgreSQL schema to ensure fast
                      query performance and clear data ownership, enforcing
                      strict access controls with row-level security
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      single-page app to Next.js with Server-Side Rendering
                      (SSR) and Incremental Static Regeneration (ISR), cutting
                      bundle size by ~35% and reducing initial page load time by
                      ~30%
                    </li>
                  </ul>
                ...
                <article className="experience-card liquid-glass">
                  ...
                  <ul className="experience-highlights">
                    <li>
                      ...
                      streamlining the real estate management process for the
                      firm
                    </li>
                    <li>
                ...
                <article className="experience-card liquid-glass">
                  ...
                  <ul className="experience-highlights">
                    <li>
                      ...
                      collaborating with engineers to prioritize fixes and
                      enhance user experience
                    </li>
                    <li>
                      Collaborated in Agile sprints (daily stand-ups, planning,
                      retrospectives), contributing feedback that kept
                      development on schedule and ensured 100% on-time delivery
              ...
              <div className="projects-grid">
                <article className="project-card liquid-glass">
                  ...
                  <div className="project-content">
                    ...
                    <p className="project-description">
                      Exploratory data analysis of San Diego Airbnb listings
                      using Python, focusing on rental price patterns,
                      neighborhood trends, and host behaviors. Utilized machine
                      learning models to uncover actionable insights for hosts
                      and travelers
                    </p>
                ...
                <article className="project-card liquid-glass">
                  ...
                  <div className="project-content">
                    ...
                    <p className="project-description">
                      ...
                      environmental soundscapes from audio recordings,
                      accurately identifying wildlife and other sound sources to
                      support ecological research and biodiversity monitoring
                      efforts
                    </p>
                    <div className="project-tech">
                      <span>Python</span>
                ...
                <article className="project-card liquid-glass">
                  ...
                  <div className="project-content">
                    ...
                    <p className="project-description">
                      Automation script that plays the Wordle game autonomously
                      by detecting on-screen game state and entering optimal
                      guesses (using letter frequency analysis), consistently
                      solving each puzzle within the allowed six attempts using
                      an algorithmically chosen start word
                    </p>
                    <div className="project-tech">
                      <span>Python</span>
                      <span>PyAutoGUI</span>
